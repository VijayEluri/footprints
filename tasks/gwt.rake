...
module Buildr
  module GWT
    ...
    class << self
      ...
      def dependencies
        %w(com.google.gwt:gwt-dev:jar:2.6.0-rc1)
      end
      ...
      def superdev_dependencies
        self.dependencies + %w(com.google.gwt:gwt-codeserver:jar:2.6.0-rc1)
      end
    ...
    module ProjectExtension
      ...
      def gwt(module_names, options = {})
        ...
        dependencies = options[:dependencies] ? artifacts(options[:dependencies]) : (project.compile.dependencies + [project.compile.target])
      ...
      def gwt_superdev_runner(module_name, options = {})
        dependencies = artifacts(options[:dependencies]) || (project.compile.dependencies + [project.compile.target])
